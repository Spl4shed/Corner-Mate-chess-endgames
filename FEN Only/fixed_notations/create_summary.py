...
header = ["Category", "Skill", "Game Over (Relative)", "Is Check (Relative)", "Is Checkmate (Relative)"]
...
with open(output_folder, "w", newline="") as csvfile:
    ...
    for item in csv_files:
        ...
        row_data = [item, file_number, f"{game_over_freq:.2f}", f"{is_check_freq:.2f}", f"{is_checkmate_freq:.2f}"]
